...
/* CPW spec */
#define C_CMP_COEF_FOR_DEBUG   1
#define C_SMP_START_LOW        (920 * C_CMP_COEF_FOR_DEBUG)    // Start of low level sampling period (80us)
#define C_SMP_STOP_LOW         (1035 * C_CMP_COEF_FOR_DEBUG)   // End of low level sampling period (100us)
#define C_SMP_START_HIGH       (920  * C_CMP_COEF_FOR_DEBUG)   // Start of high level sampling period (80us)
#define C_SMP_STOP_HIGH        (1035 * C_CMP_COEF_FOR_DEBUG)   // End of high level sampling period (100us)
				 ...
				 struct pwm_device *pwm)
{
  ...
  */
  ...
  // TC0 (ADC trigger connected to TIOA0, TI0A0 = TI0BO) /////////////////////////
  ...
  */
  ...
  /* TMP : enable setting withg test values */ 
